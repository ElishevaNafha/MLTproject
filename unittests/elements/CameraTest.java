...
public class CameraTest {
    ...
    /**
     * Test method for
     * {@link Camera#Camera(Point3D, Vector, Vector)}
     */
    @Test
    public void Camera(){
        ...
        try {
            camera = new Camera(Point3D.ZERO, new Vector(1, 1, 0), new Vector(0, -1, 0));
            fail("constructor accepts non orthogonal vectors");
        }
