...
public class ShadowTests {
	...
	//	scene.addLights(new DirectionalLight(new Color(400, 240, 0),  new Vector(1, -1, 3)));
	//	scene.addLights(new PointLight(new Color(400, 240, 0), new Point3D(-100, 100, -200), 1, 0.0000001, 0.000001));
